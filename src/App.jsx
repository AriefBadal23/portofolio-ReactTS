...
function App() {
  ...
  let projects = [
    ...
    { title: "TODO API with Blazor UI", url: "https://www.google.com", description: "ASP.NET Core API with session based authentication and frontend created with Blazor", tools: ["ASP.NET Core", "C#", "Blazor"] }]
